...
// After the animation runs, redirect to the letter page in the same folder
// reveal the thank-you note on this animation page after ~2.5s
(() => {
  try {
    ...
    // fail silently if DOM not ready or unavailable
    console.warn('Could not show thank-you element', e);
  }
})();
